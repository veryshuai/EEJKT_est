...
mm.max_client_prod = 2e5; %maximum changes in demand shock over relationship
mm.mult_match_max  = 2e5; %maximum number of matches per exogenous state change interval
mm.mms             = 1e6; %max event number (max matrix size)
