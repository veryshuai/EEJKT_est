...
mstatData     = [12.257;5.996]; %Taken from CJ_cohorts_6-15-2012.pdf in S://moments, and calculated from CJ's email of 12/18/2012 respectively
...
mstatSE     = [5.996/sqrt(48133);sqrt(2)*5.996^2/sqrt(48133)]; %all calculated from CJ's email of 12-18-2012.
