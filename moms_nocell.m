...
%% Decell array (THIS UGLY PART OF THE PROGRAM IS DUE TO THE FACT THAT WE FOUND THAT ELIMINATING CELL ARRRAY GIVES THE SIMULATION A DRASTIC SPEED BOOST.  SINCE THE REST OF THE PROGRAM USES CELL ARRAYS, WE JUST DECELL BEFORE THE SIMULATION, AND RECELL AFTER THE SIMULATION)
...
if break_flag == 0
  ...
  clearvars -except sh_val_h sh_val_f Z Phi X_f X_h st_ind_cont st_cont eta scale_f scale_h S TT burn ds sh act maxc deathmat %clear memory of unecessary stuff
