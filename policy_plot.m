...
if diff == 0
    ...
    xlabel('succeses')
    ylabel('failures')
    print(fig,'-deps',['results/', str, '_policy.eps'])
    ...
    el = 50;
    view(az,el);
    print(fig,'-deps',['results/', str, '_policy_no_suc.eps'])
    ...
    print(fig,'-depsc',['results/', str, '_policy_no_suc_2d.eps'])
...
elseif diff == 1
    ...
    xlabel('succeses')
    ylabel('failures')
    print(fig,'-deps',['results/', str, '_policy_diff'])
    ...
    el = 50;
    view(az,el);
    print(fig,'-deps',['results/', str, '_policy_no_suc_diff.eps'])
